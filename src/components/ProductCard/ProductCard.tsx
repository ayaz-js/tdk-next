...
const ProductCard: FC<Props> = ({ title, image, specifications }) => {
  return (
    <div className="card w-full shadow-xl hover:bg-[#303030] [&>figure>img]:hover:scale-[103%] [&>figure>img]:transition [&>figure>img]:duration-200">
      ...
      <div className="card-body gap-[24px] pt-[32px] pb-[40px] rounded-b-[16px]">
