...
const getSubcategories = async (slug: string) => {
    ...
    return await Promise.resolve().then(() => subcategories?.map((subcategory) => ({
...
const items = Array(8).fill({
    ...
    specifications: [`Ширина срезания макс.  - <span class="text-white font-semibold">4200 мм</span>`, `Глубина срезания - <span class="text-white font-semibold">650 мм</span>`, `Норма токсичности ОГ - <span class="text-white font-semibold">В ЕС не регулируется / US EPA Tier 4f</span>`],
